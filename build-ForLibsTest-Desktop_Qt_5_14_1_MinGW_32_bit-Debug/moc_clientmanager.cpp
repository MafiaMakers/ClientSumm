...
QT_MOC_LITERAL(5, 48, 7), // "content"
QT_MOC_LITERAL(6, 56, 12) // "sendHardware"

    },
    "Mafia::ClientManager\0getMessage\0\0id\0"
    "std::string\0content\0sendHardware"
};
...
void Mafia::ClientManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getMessage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2]))); break;
