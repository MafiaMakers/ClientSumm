...
void ClientManager::leaveRoom() {
    ...
    mafUi->close();
//    QSaveFile file("C:/Users/alexe/Documents/ClientSumm/audio.mp3");
//    file.open(QIODevice::WriteOnly);
//    file.write(audCheck->readAll());
//    std::cout << file.commit() << std::endl;
//    std::cout << "Saved\n";

//    QMediaPlayer *player = new QMediaPlayer;
//    player->setMedia(QUrl::fromLocalFile(QDir::toNativeSeparators("C:\\Users\\alexe\\Documents\\ClientSumm\\audio.raw")));
//    player->setVolume(50);
//    player->play();
}
