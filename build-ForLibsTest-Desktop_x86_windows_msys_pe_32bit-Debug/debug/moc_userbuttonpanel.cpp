...
#include <memory>
#include "../../Client-summ/Main-widget/userbuttonpanel.h"
...
QT_MOC_LITERAL(11, 120, 12), // "stopSpeaking"
QT_MOC_LITERAL(12, 133, 8), // "passExit"
QT_MOC_LITERAL(13, 142, 12), // "microChanged"
QT_MOC_LITERAL(14, 155, 13), // "cameraChanged"
QT_MOC_LITERAL(15, 169, 13), // "startGameSlot"
QT_MOC_LITERAL(16, 183, 16), // "stopContinueSlot"
QT_MOC_LITERAL(17, 200, 11), // "endGameSlot"
QT_MOC_LITERAL(18, 212, 9), // "nextStage"
QT_MOC_LITERAL(19, 222, 19) // "stopSpeakingPressed"

    },
    "Mafia::UserButtonPanel\0microStatus\0\0"
    "on\0cameraStatus\0exitApp\0startGame\0"
    "gamePause\0isPaused\0endGame\0"
    "nextStageButtonPressed\0stopSpeaking\0"
    "passExit\0microChanged\0cameraChanged\0"
    "startGameSlot\0stopContinueSlot\0"
    "endGameSlot\0nextStage\0stopSpeakingPressed"
};
...
void Mafia::UserButtonPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->stopSpeaking(); break;
        case 8: _t->passExit(); break;
        case 9: _t->microChanged(); break;
        case 10: _t->cameraChanged(); break;
        case 11: _t->startGameSlot(); break;
        case 12: _t->stopContinueSlot(); break;
        case 13: _t->endGameSlot(); break;
        case 14: _t->nextStage(); break;
        case 15: _t->stopSpeakingPressed(); break;
        default: ;
        }
        ...
        {
            using _t = void (UserButtonPanel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserButtonPanel::stopSpeaking)) {
                *result = 7;
                return;
            }
        }
...
// SIGNAL 7
void Mafia::UserButtonPanel::stopSpeaking()
{
